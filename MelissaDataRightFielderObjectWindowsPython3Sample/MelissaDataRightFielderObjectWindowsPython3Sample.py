...
class RightFielderObject:
    ...
    def __init__(self, license, data_path):
        ...
        """
        This number should match with file properties of the Melissa Data Object (dll or so) File Version.
...
def run_as_console(license, test_input, data_path):
    print("\n\n===== WELCOME TO MELISSA DATA RIGHT FIELDER OBJECT WINDOWS PYTHON3 SAMPLE =====\n")
